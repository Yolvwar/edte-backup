...
export default function StepValidation({ documentId }) {
  ...
  const handleReject = () => {
    ...
    const updatedDocument = {
      ...
      status: 'à modifier' // Nouveau statut pour indiquer que le document doit être modifié
    };
      ...
      <CardContent className="space-y-4">
        ...
        {showAlert && (
          <div className="fixed top-10 left-1/2 transform -translate-x-1/2 z-50 w-[20%]">
            <AlertPopup message={"Veuillez renseigner un justificatif en cas de refus"}/>
          </div>
        )}
